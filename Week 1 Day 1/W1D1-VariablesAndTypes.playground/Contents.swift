...
greeting = "Hello, this is the first day of LHL class"
...
//count = height
// This will not work. As Int is not the same as Double
...
count = Int(height) // Use the Int version of height variable. Double -> Int
count
